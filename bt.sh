...
wget -q -O/etc/trackers https://raw.githubusercontent.com/bahador14/blockpublictorrent-iptables/main/trackers
...
curl -s -LO https://raw.githubusercontent.com/bahador14/blockpublictorrent-iptables/main/hostsTrackers
